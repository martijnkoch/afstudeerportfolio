...
<div class="collapse" id="opzet-interview">
    ...
    <p>Om erachter te komen hoe de personen achter de drie grootste videogames in Nederland eruit zien is gekozen om interviews te houden. Ook om verschillen te ontdekken of gelijkenissen tussen gamefans. De drie grootste games in Nederland zijn Fifa, League of Legends en Counter Strike Global Offensive. Van elke videogame is een gamefan gesproken. Voor het interview is gekozen voor een semigestructureerd interview. Dit omdat de vragen rij gestructureerd zijn maar ik wel de mogelijkheid wil hebben om door te kunnen vragen mocht de respondent iets interessants zeggen.</p>
    <h4>Wat wil ik weten?</h4>
    <p>Wat is zo leuk aan de game die de respondenten fanatiek spelen? <br>
    ...
    <h4> Thijs De Veth - Fifa gamer </h4>
    ...
    <h4>YingHing Lam - League of Legends gamer</h4>
    <table class="fl-table">
        <thead>
        <tr>
            <th>Topics</th>
        ...
        <tr>
            ...
            <td>- Hoe lang speel je al League?<br> - Hoeveel uur per week ben je bezig met League?<br> - Wat maakt League leuker dan andere games voor je?<br>- Kijk je naar casual League streamers of naar League wedstrijden?<br>- Heb je wel eens geld gedonate aan een League streamer of aan een toernooi?</td>
        </tr>
        <tr>
            <td>eSports</td>
...
<h3>
    <a data-toggle="collapse" href="#interview-noel" class="collapselink interview-name">Thijs De Veth
        <img src="/assets/img/icons/double-arrow.png" alt="#"/>
    </a>
</h3>
...
<h3>
    <a data-toggle="collapse" href="#interview-david" class="collapselink interview-name">YingHing Lam   
        <img src="/assets/img/icons/double-arrow.png" alt="#"/>
    </a>
</h3>
<div class="collapse interview-david" id="interview-david">
    ...
    <p>Ik kijk altijd altijd naar de World Series van League, dit is de grote league van Riot Games zelf. Daarnaast kijk ik soms ook naar kleine toernooien. Naast de toernooien die ik kijk, kijk ik ook geregeld naar individuele streams van spelers die actief zijn in de World Series. Dit zijn spelers die ik een interessante speelstijl vind hebben, of het zijn interessante personen.  </p>
    <h4>Heb je wel eens geld gedonate aan een League streamer of aan een toernooi?</h4>
    <p>Nee, nog nooit. Donaten is vrijwillig geld geven en dat doe ik niet zomaar. Ik geef ook niet zomaar geld aan een gitarist die bij het station staat. Ik koop dan liever merchandise van een team of een streamer om hem / haar te promoten. Dan houd ik er zelf ook nog wat leuks aan over. Of van een streamer die ik graag wil steunen zou ik best wat meer advertisement willen kijken om het channel te steunen. Dat kost mij geen geld en wel wat tijd, en dat zou ik best willen opofferen. </p>
    <h4>Zie jij professionele League spelers als echte topsporters? </h4> 
    <p>Ja eigenlijk wel, deze gamers doen dingen die normale gamers nooit zouden kunnen. Ze spelen echt op een hoog niveau en verdienen hier meer credit voor in de maatschappij. 
Ik vind dat er meerdere sporten zijn waar je niet fysiek heel actief bezig bent zoals schaken of darts en zelfs die ‘sporters’ worden meer geaccepteerd in de maatschappij. Dus ja ik vind professionele gamers wel echte atleten.
    </p>
    <h4>Kijk je naast League nog naar andere games?</h4>
    <p>Ja het wisselt vaak naar games waar mijn interesses op dat moment liggen. De laatste tijd ben ik weer wat meer minecraft gaan spelen, dus hier kijk ik op momenteel weer streams van. Ook zijn er een aantal streamers die ik graag volg omdat ze erg goed zijn zoals Shroud. </p>
    <h4>Ben je wel eens naar een gaming event geweest?</h4>
    <p>Nee ik ben nog nooit ergens naartoe geweest. Ik wilde wel een keer naar de World cup van League gaan in Nederland. Maar de tickets toendertijd waren te duur. Maar als er nu een groot toernooi zou zijn en een aantal vrienden van me willen mee dan zou ik zeker meegaan. Ik wil de sfeer van zo’n groot eSports evenement wel eens proeven in het echt. </p>
    <h4>Ken je de sanquin first blood campagne?</h4>
    <p>Nee, nog nooit van gehoord. </p>
    <h4>Zou jij bloed doneren voor een unieke league of legends skin?</h4>
    <p>Ja, ik zou meedoen aan een campagne als deze van Sanquin. Ik hou van unieke skins of unieke objecten die anderen niemand hebben. Dus daarom zou ik meedoen aan zo’n actie. Voor een random skin zou ik het niet zomaar doen maar voor een unieke skin wel. </p>
    <h4>Gok je wel eens voor geld op wedstrijden van League? </h4>
    <p>Nee dit heb ik eigenlijk nog nooit gedaan. Op normale sport gok ik wel regelmatig terwijl ik hier eigenlijk niet eens zoveel van af weet. Het is eigenlijk nooit in me opgekomen om ook op eSports te gokken. Eigenlijk zou het beter zijn om op League te gokken voor me aangezien ik veel van de teams weet.</p>
    <h4>Heb je wel eens League characters gekocht?</h4>
    <p>Ik heb buiten de game nooit fysieke characters gekocht want die heb je ook. Maar ingame heb ik verschillende characters gekocht ja. De prijs van zo’n character is gemiddeld tussen de $5 en $10. </p>
    <h4>Voelt het niet zo erg om League characters te kopen omdat de game an sich al gratis is?</h4>
    <p>Nee omdat de game gratis is voelt het voor mij niet slecht om er iets in aan te schaffen. Als ik voor een game al 50 euro zou neertellen dan zal het onrechtmatig aanvoelen maar nu niet. Het is ook logisch dat een gratis game micro transactions moet hebben, want er zit natuurlijk wel een bedrijf achter dat winst wil maken. </p>
    <h4>Gebruik je een adblocker op streaming websites?</h4>
    <p>Nee deze block ik niet. Ik wil de streamers wel supporten door een reclame te kijken. </p>
    <h4>Wat voor reclames vind je irritant op streaming platforms?</h4>
...
<h3>
    <a data-toggle="collapse" href="#interview-jos" class="collapselink interview-name">Kevin Frambach  
        <img src="/assets/img/icons/double-arrow.png" alt="#"/>
    </a>
</h3>
